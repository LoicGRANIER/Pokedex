...
function setTypeBackgroundColor(pokemon) {
    ...
    const detailMainEelement = document.querySelector(".detail-main");
    setElementStyles([detailMainEelement], "backgroundColor", color);
    setElementStyles([detailMainEelement], "borderColor", color);
    setElementStyles(document.querySelector(".power-wrapper > p"), color);
...
function displayPokemonsDetails(pokemon) {
    ...
    const detailMainEelement = document.querySelector(".detail-main");
    detailMainEelement.classList.add(name.toLowerCase());
